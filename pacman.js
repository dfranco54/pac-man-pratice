...
const directions = ['U', 'D', 'L', 'R']; //U = arriba D = abajo L = Izquierda R = derecha
let score = 0;
let lives = 3;
let gameOver = false;
...
function move() {
  ...
  for (let ghost of ghosts.values()) {
    ...
    if (
      ghost.y == tileSize * 9 && ghost.direction != "U" && ghost.direction != 'D') {
